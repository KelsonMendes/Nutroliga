      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `REDES SOCIAIS`,
              subtitle: `Estamos presentes agora em quase todas.`,
              description: `Estamos criando presença digital para levar conhecimento em nutrologia para todos os cantos possíveis.`,
            }}
          />
